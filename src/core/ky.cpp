...
Security
Insights
ky/smallpt/smallpt_rewrite.cpp
@infancy
infancy add comments
Latest commit 92f218f on 14 Mar
 History
 1 contributor
1405 lines (1083 sloc)  36.8 KB
   */
...
int main1(int argc, char* argv[])
{
    ...
    int samplesPerPixel = argc == 2 ? atoi(argv[1]) / 4 : 64;
